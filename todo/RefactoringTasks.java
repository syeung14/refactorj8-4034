...
public class RefactoringTasks {
    ...
    /**
     * REFACTOR to generate stream from ServiceLoader (hint, use StreamSupport and spliterator(), loop use map(), filter(), findFirst() and Optional.orElseThrow() to complete refactoring
